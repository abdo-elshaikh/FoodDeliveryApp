...
namespace FoodDeliveryApp.ViewModels.Dashboard
{
    ...
    public class UserDashboardViewModel
    {
        ...
        public List<MenuItemViewModel> RecentlyOrderedItems { get; set; } = new();
        public List<AddressViewModel> SavedAddresses { get; set; } = new();
        public List<PaymentMethodViewModel> SavedPaymentMethods { get; set; } = new();
    ...
    public class RestaurantDashboardViewModel
    {
        ...
        public List<OrderSummaryViewModel> RecentOrders { get; set; } = new();
        public List<MenuItemViewModel> PopularItems { get; set; } = new();
        public List<ReviewListViewModel> RecentReviews { get; set; } = new();
        public List<MenuItemViewModel> LowStockItems { get; set; } = new();
        public List<MenuItemViewModel> OutOfStockItems { get; set; } = new();
    ...
    public class DeliveryDriverDashboardViewModel
    {
        ...
        public List<ReviewListViewModel> RecentReviews { get; set; } = new();
        public List<DeliveryZoneViewModel> DeliveryZones { get; set; } = new();
    }
